...
const LeaveButton = dynamic(() => import('@/features/user/ui/LeaveButton'), { ssr: false });
const UserInfo = dynamic(() => import('@/screens/mypage/ui/UserInfo'), { ssr: false });
const MyStocks = dynamic(() => import('@/features/user/ui/MyStocks'), { ssr: false });
const MyPosts = dynamic(() => import('@/features/user/ui/MyPosts'), { ssr: false });
const MyComments = dynamic(() => import('@/features/user/ui/MyComments'), { ssr: false });
