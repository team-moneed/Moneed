import { S3 } from '@/6_shared/server/s3';
...
export class S3Service {
    ...
    async uploadImage(domain: 'posts' | 'profile', image: File) {
        ...
        try {
            ...
            const uploadedImageUrl = `https://${process.env.AWS_BUCKET_NAME}.s3.${process.env.AWS_REGION || 'ap-northeast-2'}.amazonaws.com/${fileName}`;
