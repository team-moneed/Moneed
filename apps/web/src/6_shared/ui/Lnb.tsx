import LnbLink from '@/6_shared/ui/LnbLink';
        ...
        <>
            ...
            >
                ...
                <div className='pt-42 flex-1 flex flex-col gap-[1.8rem]'>
                    ...
                    <LnbLink to={PATH.SHORTFORM} icon='/icon/icon-lnb-2.svg' activeIcon='/icon/icon-lnb-2-on.svg'>
                        <span className={`text-[1.4rem] font-semibold w-[8.4rem] ${active ? 'block' : 'hidden'}`}>
                            숏폼
                        </span>
                    </LnbLink>
                    <LnbLink to={PATH.COMMUNITY} icon='/icon/icon-lnb-3.svg' activeIcon='/icon/icon-lnb-3-on.svg'>
                        <span className={`text-[1.4rem] font-semibold w-[8.4rem] ${active ? 'block' : 'hidden'}`}>
                            커뮤니티
                        </span>
                    </LnbLink>
                ...
                <div className={`shrink-0 pb-8 ${active ? 'block' : 'hidden'}`}>
                    ...
                    <div className='flex items-center gap-x-[.8rem] flex-wrap mt-[.8rem]'>
                        <Link
                            to={URL.TERMS_OF_SERVICE}
                            className='text-moneed-gray-7 text-[1rem] font-semibold leading-[135%]'
                        >
                            이용약관
                        </Link>
                        <i className='w-[.1rem] h-4 bg-moneed-gray-7'></i>
                        <Link
                            to={URL.PRIVACY_POLICY}
                            className='text-moneed-gray-7 text-[1rem] font-semibold leading-[135%]'
                        >
                            개인정보처리방침
                        </Link>
