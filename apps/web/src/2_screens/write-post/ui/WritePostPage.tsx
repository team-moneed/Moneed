...
import BottomModal from '@/6_shared/ui/BottomModal';
...
import { createPost } from '@/4_features/post/api';
...
const WritePost = () => {
    ...
    const movetoSearchStocktype = () => {
        router.push(PATH.SEARCHSTOCKTYPE);
    };
    ...
    const onSubmit = async (data: CreatePostForm) => {
        ...
        const res = await createPost(PostMapper.toCreateDTO({ ...data, symbol, thumbnailImage: image }));
