...
export const DYNAMIC_PATH = {
    ...
    EDITPOST_ID: (postId: number) => `/editpost/${postId}` as const,
    WRITEPOST_SYMBOL: (symbol: string) => `/writepost/${symbol}` as const,
...
export const DYNAMIC_API_PATH = {
    ...
    GET_COMMENTS: (postId: number) => `${API_PATH.COMMENTS}/${postId}` as const,
