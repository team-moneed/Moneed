...
import { CreatePostRequestDTO, CreatePostResponse, PostDTO, PostMapper } from '@/5_entities/post';
import {
    DeletePostResponse,
    UpdatePostRequest,
    UpdatePostResponse,
    LikePostResponse,
    UnlikePostResponse,
} from '@/4_features/post/model/post.type';
import { isFile } from '@/6_shared/utils/typeChecker';
import { DYNAMIC_API_PATH } from '@/6_shared/config/path';
import { CommentDTO, CommentMapper } from '@/5_entities/comment';
